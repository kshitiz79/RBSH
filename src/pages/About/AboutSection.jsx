      ...
      <section className="fixed top-12 left-0 w-full h-screen bg-[#e5e8ea] text-[#0A0D11] border-t border-[#0A0D11] mt-10">
        <div className="w-full h-full ">
          ...
          <motion.div
            ...
            className="absolute  md:mt-0 -mt-80 left-0 h-full w-[60%] flex justify-center px-10 z-0"
          >
            {/* Main SVG Text Block (Already present) */}
            <div className="left-4 ">
              <svg
                className=" mt-2 sm:w-[870px] sm:rotate-0 origin-top-left"
                width="870"
                height="261"
                viewBox="0 0 870 261"
                fill="none"
          ...
          <motion.div
            style={{ x: leftTranslateX }}
            className="absolute bottom-20 left-0 w-[60%] z-0"
          >
            <div className="p-4">
              <svg
          ...
          >
            ...
            <motion.div
              ...
              className="h-[40vh]  border-b border-[#0A0D11] "
            >
              <motion.video
                src="/ABOUTUS.mp4"
                autoPlay
            ...
            <div className="h-[60vh] px-6">
              <div className="h-full flex flex-col justify-between max-w-2xl ml-auto">
                <h2 className="text-[2.4rem] leading-none pt-2">
                  We Don’t Just Build We Create Impact
                </h2>
                <p className="text-lg pb-28">
