...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_8tpkzl5", // Your EmailJS service ID
        "template_xsqdxx8", // Your EmailJS template ID
        form.current,
        "cOgeWE_ZecC61i1YX" // Your EmailJS public key
      )
      .then(
        () => {
      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="form-section p-4 sm:p-6 md:p-8">
          ...
          <form ref={form} onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div>
              <label htmlFor="organization" className="block text-sm font-medium text-gray-700">Your Organization's Name</label>
              <input
                type="text"
                id="organization"
                name="organization"
            ...
            <div>
              <label htmlFor="website" className="block text-sm font-medium text-gray-700">Website/Social Media Link</label>
              <input
                type="url"
                id="website"
                name="website"
